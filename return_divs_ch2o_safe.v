From ch2o_compcert Require Export return_divs_ch2o_core_c ch2o_safety_bigstep.
From ch2o Require Export restricted_smallstep.

Local Open Scope string_scope.

Theorem return_divs_ch2o_safe: ch2o_safe_program Γ δ (λ z, z = 2%Z).
Proof.
...
rewrite H2 at 2.
repeat constructor; try (unfold int_lower || unfold int_upper); simpl; lia.
Qed.
